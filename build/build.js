...
require.register("marionettejs~backbone.babysitter@v0.1.4", function (exports, module) {
// Backbone.BabySitter
// -------------------
// v0.1.4
//
...
require.register("marionettejs~backbone.marionette@v1.8.5", function (exports, module) {
...
(function (root, factory) {
  if (typeof exports === 'object') {
    ...
    var underscore = require("jashkenas~underscore@1.6.0");
    var backbone = require("jashkenas~backbone@1.1.2");
    var wreqr = require("marionettejs~backbone.wreqr@v1.3.1");
    var babysitter = require("marionettejs~backbone.babysitter@v0.1.4");
